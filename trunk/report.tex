...
\section{\textbf{Existing Work on WSN clock synchronization}}\par
...
\section{\textbf{Clock Synchronization in centralized networks}}
...
\end{equation}
where $\beta_1$ and $\beta_2$ are the parameters to be estimated.\par
...
the state of the network to be. \par
...
\end{figure}
Figure $\ref{16output0}$ shows the synchronization error for $20$ nodes operating in a static environment. KF\nomenclature{KF}{Kalman Filter} has the lowest precision of synchronization error, at an avergage of $4clk$. NLLS and WM perform similarly at average precision of $12clk$ while Median performs well at $13clk$. \paragraph*{}
