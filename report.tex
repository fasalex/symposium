...
\textbf{Definition} : A clock cycle (clk)(\nomenclature{\textit{clk}}{A clock cycle} ) is the time between two adjacent pulses of the oscillator. The number of these pulses per second is known as the clock speed, measured in kHz, MHz.
